...
public class VenteVisitorTest {
    ...
    void parse_vente_materiel_standard() {
        ...
        var input = "* `vente` Dates:ajd, vendre Trésoreries:voiture pour 8000000Ar vers Comptes:compte";
    ...
    void parse_vente_materiel_date_future() {
        ...
        var input = "* `vente` Dates:dateFuture, vendre Trésoreries:voiture pour 8000000Ar vers Comptes:compte";
    ...
    void parse_vente_materiel_date_passee() {
        ...
        var input = "* `vente` Dates:datePassee, vendre Trésoreries:voiture pour 8000000Ar vers Comptes:compte";
    ...
    void parse_vente_avec_expression_complexe_prix() {
        ...
        var input = "* `vente` Dates:ajd, vendre Trésoreries:voiture pour (Nombres:prixBase - Nombres:rabais)Ar vers Comptes:compte";
    ...
    void parse_vente_possession_inconnue() {
        ...
        var input = "* `vente` Dates:ajd, vendre Trésoreries:inexistante pour 1000Ar vers Comptes:compte";
    ...
    void parse_vente_date_invalide() {
        ...
        var input = "* `vente` Dates:inexistante, vendre Trésoreries:objet pour 1000Ar vers Comptes:compte";
