...
public class PatrimoineZetyCasTest {
    ...
    public void testValeurPatrimoine() {
        ...
        var dateDebut = LocalDate.of(2024, JUILLET, 3);
        ...
        new FluxArgent("Frais de scolarité", argentLiquide, LocalDate.of(2023, NOVEMBRE, 27), LocalDate.of(2024, AOUT, 27), -200_000, 27);
        new FluxArgent("Frais bancaires", compteBancaire, dateDebut, LocalDate.of(2024, SEPTEMBRE, 17), -20_000, 25);
        ...
        LocalDate dateFutur = LocalDate.of(2024, SEPTEMBRE, 17);
    ...
    public void testValeurPatrimoineAvecDette() {
        ...
        // Ajouter la dette
        var dateDette = LocalDate.of(2024, SEPTEMBRE, 18);
        ...
        LocalDate dateAvantDette = LocalDate.of(2024, SEPTEMBRE, 17);
        LocalDate dateApresDette = LocalDate.of(2024, SEPTEMBRE, 18);
    ...
    public void testValeurPatrimoineAvecManqueDEspeces() {
        ...
        new FluxArgent("Frais de scolarité", argentLiquide, LocalDate.of(2023, NOVEMBRE, LocalDate.of(2023, NOVEMBRE, 27), LocalDate.of(2024, AOUT, 27), -200_000, 27);
        new FluxArgent("Frais bancaires", compteBancaire, dateDebut, LocalDate.of(2024, SEPTEMBRE, 17), -20_000, 25);
        ...
        LocalDate dateManqueDEspeces = LocalDate.of(2024, OCTOBRE, 1);
