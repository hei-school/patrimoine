...
class TrainDeVieTest {
  ...
  void un_train_de_vie_financé_par_argent() {
    ...
    var dateDebut = Instant.parse("2023-02-14T00:00:00.00Z");
    var dateFin = Instant.parse("2024-07-13T00:00:00.00Z");

    var trainDeVie = new TrainDeVie(null, 200_000, dateDebut, dateFin, financeur, 1);
    assertEquals(0, trainDeVie.projectionFuture(dateFin).getFinancePar().getValeurComptable());
  }
}