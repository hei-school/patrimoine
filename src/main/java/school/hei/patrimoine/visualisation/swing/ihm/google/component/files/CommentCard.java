...
public class CommentCard extends JPanel {
    ...
    public CommentCard(Comment comment, boolean showActions) {
    ...
    private void showRepliesDialog(Comment parentComment) {
        var dialog = new Dialog("Réponses au commentaire", 800, 600);
        ...
        var mainWrapper = new CommentCard( comment, false).toWrappedCard();
        ...
        if (replies.isEmpty()) {
            ...
            for (var reply : replies) {
                var wrapper = new CommentCard(reply, false).toWrappedCard();
