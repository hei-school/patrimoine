...
public class ValeurMarcheVisitorTest {
  ...
  void parse_valeur_marche_materiel() {
    var possession = new Materiel("maisonTest", AJD, AJD, new Argent(1_000_000, Devise.MGA), 2.0);
    ...
    var expected = new ValeurMarche(possession, AJD, ariary(1_000_000));
  ...
  void parse_valeur_marche_date_passee() {
    var possession = new Materiel("voiture", DATE_PASSEE, DATE_PASSEE, ariary(10_000_000), 10.0);
    ...
    var expected = new ValeurMarche(possession, DATE_PASSEE, ariary(8_000_000));
    ValeurMarche actual = visitor.visit(input, PatriLangParser::valeurMarche);
  ...
  void parse_valeur_marche_date_future() {
    var possession = new Materiel("ordinateur", AJD, AJD, ariary(2_000_000), 5.0);
    ...
    var expected = new ValeurMarche(possession, DATE_FUTURE, ariary(1_500_000));
    ValeurMarche actual = visitor.visit(input, PatriLangParser::valeurMarche);
