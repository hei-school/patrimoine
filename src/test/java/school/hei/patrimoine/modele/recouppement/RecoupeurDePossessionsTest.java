    ...
    void generer_correction_pour_flux_argent_decomposer() {
        ...
        var prévu =
                Patrimoine.of(
                    ...
                    Set.of(
                        comptePersonnelPrévu,
                        new FluxArgent("salaire", comptePersonnelPrévu, au02Mars2025, au02Juin2025, 2, ariary(200))));
        ...
        var réalité =
                Patrimoine.of(
                        ...
                        Set.of(
                            comptePersonnelRéalité,
                            new FluxArgent("salaire__du_" + au02Mars2025, comptePersonnelRéalité, au02Mars2025, ariary(200)),
                            new FluxArgent("salaire__du_" + au02Mai2025, comptePersonnelRéalité, au02Mai2025, ariary(200))
                        ));
