...
public class FluxJournalierGrid extends RoundedGrid<FluxJournalier> implements Observer {
  private final PatrimoinesState patrimoinesState;

  public FluxJournalierGrid(PatrimoinesState patrimoinesState) {
  ...
  public void update(Observable observable, Object o) {
    setItems(
        this.patrimoinesState.getEvolutionPatrimoine().getFluxJournaliers().stream()
