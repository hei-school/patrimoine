...
class ArgentTest {
    @Test
    void argent_dans_compte_courant_moins_train_de_vie() {
        ...
        var au30Aout24 = Instant.parse("2024-08-30T00:00:00.00Z");
        assertEquals(-900_000, compteCourant.projectionFuture(au30Aout24).valeurComptable);
    }
}
