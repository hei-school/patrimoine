...
public record DriveNamedIdDownloader(FileNameExtractor fileNameExtractor, DriveApi driveApi)
    ...
    public final static String DOWNLOAD_PLANNED_FILE_DIRECTORY_PATH = DOWNLOADS_DIRECTORY_PATH + "/planned";
    public final static String DOWNLOAD_DONE_FILE_DIRECTORY_PATH = DOWNLOADS_DIRECTORY_PATH + "/done";
    ...
    @Override
    public GoogleLinkList<NamedID> apply(GoogleLinkList<NamedID> ids) throws GoogleIntegrationException {
