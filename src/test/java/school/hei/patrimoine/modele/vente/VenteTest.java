...
public class VenteTest {
    ...
    void vente_doit_transferer_argent_vers_compte() {
        ...
        // Vérifier que le compte a bien reçu l'argent
...
//
//        materiel.ajouterValeurMarche(new ValeurMarche(materiel, date1, new Argent(250_000, Devise.EUR)));
//        materiel.ajouterValeurMarche(new ValeurMarche(materiel, date2, new Argent(300_000, Devise.EUR)));
//
