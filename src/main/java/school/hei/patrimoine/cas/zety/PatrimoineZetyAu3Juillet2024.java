...
public class PatrimoineZetyAu3Juillet2024 implements Supplier<Patrimoine> {
	...
	private static Set<Possession> possessionsDu3Juillet2024(Materiel ordinateur, Materiel vêtements, Argent espèces, Argent compteBancaire) {
		new FluxArgent("scolarité 2023-2024", espèces, LocalDate.of(2023, NOVEMBER, 1), LocalDate.of(2024, AUGUST, 28), -200_000, 27, MGA);
		new FluxArgent("frais de tenue de compte", compteBancaire, AU_3_JUILLET_2024, LocalDate.MAX, -20_000, 25, MGA);
	...
	private static Set<Possession> possessionsRajoutéesLe18Septembre2024(Argent compteBancaire) {
		...
		new FluxArgent("remboursement de la dette", compteBancaire, dateDeRemboursementDette, dateDeRemboursementDette, valeurDetteARembourser, dateDeRemboursementDette.getDayOfMonth(), MGA);
		int valeurDetteRajoutéeAuCompte = 10_000_000;
		new FluxArgent("flux de la dette", compteBancaire, dateDePriseDeffetDette, dateDePriseDeffetDette, valeurDetteRajoutéeAuCompte, dateDePriseDeffetDette.getDayOfMonth(), MGA);
		return Set.of(dette);
	}
	...
	private static Set<Possession> possessionsRajoutéesAprèsLe18Septembre2024(Argent espèces, Argent compteBancaire) {
		...
		new FluxArgent("frais de scolarité 1 fois", compteBancaire, au21Septembre2024, au21Septembre2024, -2_500_000, au21Septembre2024.getDayOfMonth(), MGA);
		new FluxArgent("dons parentaux", espèces, LocalDate.of(2024, JANUARY, 1), LocalDate.MAX, 100_000, 15, MGA);
		new FluxArgent("train de vie mensuel", espèces, LocalDate.of(2024, OCTOBER, 1), LocalDate.of(2025, FEBRUARY, 13), -250_000, 1, MGA);
		return Set.of();
	}
	...
	public Patrimoine zetySendette() {
		...
		var espèces = espèces();
		var compteBancaire = compteBancaire();
		GroupePossession possessionsDu3Juillet = new GroupePossession("possessions du 3 Juillet", AU_3_JUILLET_2024, possessionsDu3Juillet2024(ordinateur, vêtements, espèces, compteBancaire), MGA);
		GroupePossession possessionsRajoutéesLe18Septembre = new GroupePossession("possessions ajoutées le 18 Septembre 2024", AU_18_SEPTEMBRE_2024, possessionsRajoutéesLe18Septembre2024(compteBancaire), MGA);
	...
	public Argent argentEnEspècesDeZetyEn20242025() {
		...
		var espèces = espèces();
		var compteBancaire = compteBancaire();
		new GroupePossession("possessions du 3 Juillet", AU_3_JUILLET_2024, possessionsDu3Juillet2024(ordinateur, vêtements, espèces, compteBancaire), MGA);
		new GroupePossession("possessions ajoutées le 18 Septembre 2024", AU_18_SEPTEMBRE_2024, possessionsRajoutéesLe18Septembre2024(compteBancaire), MGA);
		new GroupePossession("possessions ajoutées après le 18 Septembre", AU_18_SEPTEMBRE_2024, possessionsRajoutéesAprèsLe18Septembre2024(espèces, compteBancaire), MGA);
	...
	public Patrimoine patrimoineDeZetyLe14Fevrier2025() {
		...
		var espèces = espèces();
		var compteBancaire = compteBancaire();
		GroupePossession possessionsDu3Juillet2024 = new GroupePossession("possessions du 3 Juillet", AU_3_JUILLET_2024, possessionsDu3Juillet2024(ordinateur, vêtements, espèces, compteBancaire), MGA);
		GroupePossession possessionsRajoutéesLe18Septembre2024 = new GroupePossession("possessions ajoutées le 18 Septembre 2024", AU_18_SEPTEMBRE_2024, possessionsRajoutéesLe18Septembre2024(compteBancaire), MGA);
		GroupePossession possessionsRajoutéesAprèsLe18Septembre2024 = new GroupePossession("possessions ajoutées après le 18 Septembre", AU_18_SEPTEMBRE_2024, possessionsRajoutéesAprèsLe18Septembre2024(espèces, compteBancaire), MGA);
