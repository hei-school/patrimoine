...
public class AchatMaterielVisitor
    implements SimpleVisitor<AcheterMaterielContext, OperationComptable> {
  private final VariableVisitor variableVisitor;

  @Override
  public OperationComptable apply(AcheterMaterielContext ctx) {
    ...
    return OperationComptable.make(achat);
  }
}
