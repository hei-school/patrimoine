...
class PatrimoineTest {
  ...
  void patrimoine_zety_17_septembre () {
    ...
    var financeur = new Argent("Espèces", au3juillet2024.minusDays(1), au3juillet2024, 2_000_000);
    var fraisDeScolarite = 2_000_000;

    var ordinateur = new Materiel(
            "MacBook Pro",
            au3juillet2024,
            1_200_000,
            au3juillet2024.minusDays(0),
            0);
    ...
    var patrimoineZetyAu17septembre24 = new Patrimoine(
            ...
            Set.of(
                    ...
                    new GroupePossession("Le groupe", au3juillet2024, Set.of(financeur, ordinateur, vetement))
            )
    );

    assertEquals(5_560_000, patrimoineZetyAu17septembre24.projectionFuture(au3juillet2024.plusDays(46)).getValeurComptable());
