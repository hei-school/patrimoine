...
public class CommentOperationVisitorTest {
  ...
  void setup() {
    ...
    visitor =
        new UnitTestVisitor() {
          @Override
          public List<OperationComments> visitPiecesJustificatives(
  ...
  void parse_comments() {
    ...
    List<OperationComments> result = visitor.visit(input, PatriLangParser::piecesJustificatives);
