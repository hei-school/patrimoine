...
public class PatrimoineZetyDetteCas implements Supplier<Patrimoine> {
    ...
    public Patrimoine get() {
        ...
        new FluxArgent("Frais de scolarité 2023-2024", argentLiquide, LocalDate.of(2023, 11, 27), LocalDate.of(2024, 8, 27), -200_000, 27);
        ...
        new FluxArgent("Annulation Dette bancaire", dette, dateRemboursement, dateRemboursement, 11_000_000, dateRemboursement.getDayOfMonth());

        return new Patrimoine("Zety est endetté", zety, dateDebut, Set.of(ordinateur, vetements, argentLiquide, compteBancaire, dette));
    }
}
