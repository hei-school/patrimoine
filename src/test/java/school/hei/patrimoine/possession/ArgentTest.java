...
class ArgentTest {
    ...
    void diminution_du_compte_courrant_de_ilo_au_14_juillet_2024(){
        ...
        new TrainDeVie("train de vie", 500_000,
    ...
    @Test
    void ponction_du_compte_courrant_à_la_date_de_ponction(){
        var au13mai24 = Instant.parse("2024-05-13T00:00:00.00Z");
        var compteCourant = new Argent("Compte courant", au13mai24, 600_000);
        ...
        var au05juin24 = Instant.parse("2024-06-05T00:00:00.00Z");
        var projectionDuCompte = compteCourant.projectionFuture(au05juin24);
        assertEquals(100_000, projectionDuCompte.getValeurComptable());
    }
}