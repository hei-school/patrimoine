...
class NombreValidatorTest {
    ...
    void validate() {
        ...
        // Invalid numbers
        Exception exception1 = assertThrows(IllegalArgumentException.class, () -> NombreValidator.validate("abc"));
        assertEquals("Nombre invalide 'abc' (syntaxe incorrecte)", exception1.getMessage());

        Exception exception2 = assertThrows(IllegalArgumentException.class, () -> NombreValidator.validate("12.34.56"));
        assertEquals("Nombre invalide '12.34.56' (syntaxe incorrecte)", exception2.getMessage());

        Exception exception3 = assertThrows(IllegalArgumentException.class, () -> NombreValidator.validate(null));
        assertEquals("Nombre invalide 'null' (syntaxe incorrecte)", exception3.getMessage());

        Exception exception4 = assertThrows(IllegalArgumentException.class, () -> NombreValidator.validate("12a34"));
