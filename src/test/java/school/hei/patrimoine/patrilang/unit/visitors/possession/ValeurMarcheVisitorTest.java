...
public class ValeurMarcheVisitorTest {
    ...
    UnitTestVisitor visitor = new UnitTestVisitor() {
        @Override
        public school.hei.patrimoine.modele.ValeurMarche.ValeurMarche visitValeurMarche(
    ...
    """;
        ...
        String expectedMessage = "Seules les possessions de type IMMOBILISATION ou ENTREPRISE peuvent avoir une valeur de marché.";
