...
public class FluxArgentDecomposeurTest {
    ...
    void decompose_flux_d_une_seule_date() {
        ...
        var flux = new FluxArgent("Salaire unique", compte,
    ...
    void decompose_flux_mensuel_sur_trois_mois() {
        ...
        var flux = new FluxArgent("Salaire", compte,
        ...
        assertEquals("Salaire__du_2025-01-12", actual.get(0).nom());
        assertEquals("Salaire__du_2025-02-12", actual.get(1).nom());
        assertEquals("Salaire__du_2025-03-12", actual.get(2).nom());
    }
