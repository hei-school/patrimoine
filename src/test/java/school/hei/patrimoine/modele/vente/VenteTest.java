...
public class VenteTest {
  ...
  void valeur_marche_doit_valider_les_parametres() {
    assertThrows(
        IllegalArgumentException.class, () -> new ValeurMarche(null, new Argent(100, Devise.EUR)));

    assertThrows(IllegalArgumentException.class, () -> new ValeurMarche(LocalDate.now(), null));
  }
