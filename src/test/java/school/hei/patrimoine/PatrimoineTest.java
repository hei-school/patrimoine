...
class PatrimoineTest {
  ...
  void patrimoine_vide_vaut_0() {
    ...
    var patrimoineIloAu13mai24 = new Patrimoine(ilo, Instant.parse("2024-05-13T00:00:00.00Z"), Set.of());
  ...
  void combien_vaut_le_patrimoine_de_Ilo_le_26_juin_2024() {
    ...
    var trainDeVie = new TrainDeVie("Train de Vie", 500_000, debutTrainDeVie, finTrainDeVie, compteCourant, 1);

    var dateAchatOrdinateur = Instant.parse("2021-10-26T00:00:00.00Z");
    var ordinateur = new Materiel("Ordinateur", dateAchatOrdinateur, 2_000_000, -0.10);

    var dateEvaluationVetements = Instant.parse("2024-01-01T00:00:00.00Z");
    var vetements = new Materiel("Vetements", dateEvaluationVetements, 1_000_000, -0.20);
    ...
    var projectionPatrimoine = patrimoineIloAu13mai24.projectionFuture(au26juin24);
  ...
  void combien_vaut_le_patrimoine_de_Ilo_le_14_juillet_2024() {
    ...
    var date14juillet24 = Instant.parse("2024-07-14T00:00:00.00Z");

    var espece = new Argent("Espèces", date14juillet24, 400_000);
    var compteEpargne = new Argent("Compte Epargne", date14juillet24, 200_000);
    var compteCourant = new Argent("Compte Courant", date14juillet24, 600_000);
    ...
    var patrimoineIloAu14juillet24 = new Patrimoine(
            ilo,
            date14juillet24,
            Set.of(espece, compteEpargne, compteCourant, trainDeVie, ordinateur, vetements)
    );

    var valeurPatrimoine = patrimoineIloAu14juillet24.getValeurComptable();
    assertEquals(valeurPatrimoine, patrimoineIloAu14juillet24.getValeurComptable());

    var montantCompteCourant = patrimoineIloAu14juillet24.getMontantCompteCourant();
