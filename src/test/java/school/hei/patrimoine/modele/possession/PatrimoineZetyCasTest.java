...
public class PatrimoineZetyCasTest {
    ...
    @Test
    void patrimoneZetyon14_fevrier_2025() {
        var zety = new Personne("Zety");
        ...
        var fraisDeScolarite2024a2025 = new FluxArgent(
        ...
        var empruntFraisDeScolarite = new FluxArgent(
        ...
        var donDesParents = new FluxArgent("Don parents", espece, debut2024, LocalDate.MAX, 100_000, 15);
        ...
        var patrimoineZetyAu03Juillet2024 = new Patrimoine(
                        "ZetyPatrimoineAu03Juillet2024",
                        zety,
                        au03Juillet2024,
