...
class MaterielTest {
  ...
  @Test
  void test_materiel_getTypeFEC() {
    var date = LocalDate.of(2025, JUNE, 15);
    var materiel = new Materiel("voiture", date.minusDays(5), date, ariary(10000), -0.15);

    assertNotNull(materiel.getTypeFEC());
    assertEquals(TypeFEC.IMMOBILISATION, materiel.getTypeFEC());
  }
}
