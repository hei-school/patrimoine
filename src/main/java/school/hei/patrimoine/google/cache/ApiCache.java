...
public class ApiCache {
    ...
    private final static ApiCache INSTANCE = new ApiCache();
    ...
    public <T> ThrowingSupplier<T> wrap(String type, String key, ThrowingSupplier<T> provider) throws GoogleIntegrationException {
        return () -> {
